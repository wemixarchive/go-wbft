...
func (s *Suite) TestSnapGetAccountRange(t *utesting.T) {
	...
	tests := []accRangeTest{
		// Tests decreasing the number of bytes
		{
			...
			expAccounts:  71,
			expFirst:     firstKey,
			expLast:      common.HexToHash("0x5ca23f91fefb93f286e7e245a0fe4d7018dfbfc71d39f9d80ff6ae95a304165f"),
		...
		},
		{
			...
			expAccounts:  54,
			expFirst:     firstKey,
			expLast:      common.HexToHash("0x4d79fea6c7fef10cb0b5a8b3d85b66836a131bec0b04d891864e6fdb9794af75"),
		...
		},
		{
			...
			expAccounts:  36,
			expFirst:     firstKey,
			expLast:      common.HexToHash("0x323982bb110cddfe49cc86eea33d47fa410394e47cd185814cf8e3d7573b216a"),
...
The server should return the first available account of the state as the first item.`,
		},
		{
			...
			expAccounts:  71,
			expFirst:     secondKey,
			expLast:      common.HexToHash("0x5d09cbe91ea3932998d10a7c8106f1f4fca78689ff14cc078317a695f449ce14"),
...
server to return no data because genesis is older than 127 blocks.`,
...

		{
			...
			expAccounts:  69,
			expFirst:     firstKey,
			expLast:      common.HexToHash("0x6e9e5296c3f88a6ee0f51246dc1237dec2b78db9938cd04f404f44bc0b70a479"),
...
The server should reject the request.`,
...

		{
			...
			expHashes: []common.Hash{
				...
				common.HexToHash("0x21432ea23baa6cac057ca1118fe252ef2ab2fc7a686d551d56033a675acca094"),
				common.HexToHash("0x14abbe92b4fc2d33784a076907c25cee0f28929d63d656c6f4bf04982d57542f"),
