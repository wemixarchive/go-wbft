...
func (s *Suite) TestSnapGetAccountRange(t *utesting.T) {
	...
	tests := []accRangeTest{
		// Tests decreasing the number of bytes
		{
			...
			expAccounts:  69,
			expFirst:     firstKey,
			expLast:      common.HexToHash("0x59f49281260efa7511a50c95aebc610a48a19aeaa54f041e1373b81b698989d3"),
		...
		},
		{
			...
			expAccounts:  51,
			expFirst:     firstKey,
			expLast:      common.HexToHash("0x448717f258267a130bd10b361c293b918047608106b21f4bdaff520b90586d4e"),
...
The server should return the first available account of the state as the first item.`,
		},
		{
			...
			expAccounts:  70,
			expFirst:     secondKey,
			expLast:      common.HexToHash("0x5c1d92594d6377fe6423257781b382f94dffcde4fadbf571aa328f6eb18f8fcd"),
