...
var (
	walletCommand = &cli.Command{
		...
		ArgsUsage: "",
		Description: `
    gwemix wallet import /path/to/my/presale.wallet
		...
		Subcommands: []*cli.Command{
			{
				...
				Description: `
	gwemix wallet [options] /path/to/my/presale.wallet
...
For non-interactive use the password can be specified with the --password flag:
    ...
    gwemix account update [options] <address>
...
For non-interactive use the password can be specified with the -password flag:
    ...
    gwemix account import [options] <keyfile>
