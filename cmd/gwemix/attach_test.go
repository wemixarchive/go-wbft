...
// TestAttachWithHeaders tests that 'gwemix attach' with custom headers works, i.e
...
// TestAttachWithHeaders tests that 'gwemix db --remotedb' with custom headers works, i.e
// that custom headers are forwarded to the target.
