...
var (
	...
	consoleCommand = &cli.Command{
		...
		Description: `
The gwemix console is an interactive shell for the JavaScript runtime environment
...
which exposes a node admin interface as well as the Ðapp JavaScript API.
See https://geth.ethereum.org/docs/interacting-with-geth/javascript-console.
This command allows to open a console on a running gwemix node.`,
	}
...
// localConsole starts a new gwemix node, attaching a JavaScript console to it at the
// same time.
...
// remoteConsole will connect to a remote gwemix instance, attaching a JavaScript
// console to it.
func remoteConsole(ctx *cli.Context) error {
	...
	if err != nil {
		utils.Fatalf("Unable to attach to remote gwemix: %v", err)
	}
	config := console.Config{
		DataDir: utils.MakeDataDir(ctx),
		DocRoot: ctx.String(utils.JSpathFlag.Name),
...
// ephemeralConsole starts a new gwemix node, attaches an ephemeral JavaScript
