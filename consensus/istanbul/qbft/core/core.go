...
// ## Quorum QBFT START : use consensus/istanbul/core instead of consensus/istanbul/qbft/core
var (
...
func New(backend istanbul.Backend, config *istanbul.Config) istanbul.Core {
	c := &core{
		...
		backend:            backend,
		backlogs:           make(map[common.Address]*prque.Prque[int64, qbfttypes.QBFTMessage]),
