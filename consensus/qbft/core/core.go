...
func verifySeal(header *types.Header, round uint32, sealType SealType, seal []byte, sealer common.Address, valSet qbft.ValidatorSet) error {
	...
	if _, val := valSet.GetByAddress(sealer); val == nil {
		return errInvalidSigner
	}
	return nil
}
