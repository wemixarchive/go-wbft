...
//
// This file is derived from quorum/consensus/istanbul/qbft/core/roundstate.go (2024.07.25).
...
func newRoundState(view *qbft.View, validatorSet qbft.ValidatorSet, preprepare *qbftmessage.Preprepare, preparedRound *big.Int, preparedBlock qbft.Proposal, pendingRequest *Request, hasBadProposal func(hash common.Hash) bool) *roundState {
	return &roundState{
		round:      view.Round,
...
type roundState struct {
	round      *big.Int
	sequence   *big.Int
	Preprepare *qbftmessage.Preprepare
...
func (s *roundState) SetPreprepare(preprepare *qbftmessage.Preprepare) {
	s.mu.Lock()
	defer s.mu.Unlock()
...
func (s *roundState) Proposal() qbft.Proposal {
	s.mu.RLock()
	defer s.mu.RUnlock()
