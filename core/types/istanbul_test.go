...
func TestExtractToQBFTExtra(t *testing.T) {
	testCases := []struct {
		...
		{
			// normal case
			hexutil.MustDecode(""),
			&QBFTExtra{
				VanityData: []byte{},
				EpochInfo: &EpochInfo{
					Stakers: []*Staker{
