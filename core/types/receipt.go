...
func (r *Receipt) decodeTyped(b []byte) error {
	...
	switch b[0] {
	case DynamicFeeTxType, AccessListTxType, FeeDelegateDynamicFeeTxType, BlobTxType:
		var data receiptRLP
...
func (rs Receipts) EncodeIndex(i int, w *bytes.Buffer) {
	...
	w.WriteByte(r.Type)
	switch r.Type {
	case AccessListTxType, DynamicFeeTxType, FeeDelegateDynamicFeeTxType, BlobTxType:
		rlp.Encode(w, data)
	default:
