...
type Receipt struct {
	...
	// Implementation fields: These fields are added by gwemix when processing a transaction.
...
func (r *Receipt) decodeTyped(b []byte) error {
	...
	switch b[0] {
	case DynamicFeeTxType, AccessListTxType, FeeDelegateDynamicFeeTxType, BlobTxType, SetCodeTxType:
		var data receiptRLP
...
func (rs Receipts) EncodeIndex(i int, w *bytes.Buffer) {
	...
	w.WriteByte(r.Type)
	switch r.Type {
	case AccessListTxType, DynamicFeeTxType, FeeDelegateDynamicFeeTxType, BlobTxType, SetCodeTxType:
		rlp.Encode(w, data)
	default:
