...
func (tx *Transaction) MarshalJSON() ([]byte, error) {
	...
	case *FeeDelegateDynamicFeeTx:
		nonce := itx.SenderTx.Nonce
		enc.Nonce = (*hexutil.Uint64)(&nonce)
		gas := itx.SenderTx.Gas
		enc.Gas = (*hexutil.Uint64)(&gas)
		enc.ChainID = (*hexutil.Big)(itx.SenderTx.ChainID)
		accessList := itx.SenderTx.AccessList
		enc.AccessList = &accessList
		enc.MaxFeePerGas = (*hexutil.Big)(itx.SenderTx.GasFeeCap)
		enc.MaxPriorityFeePerGas = (*hexutil.Big)(itx.SenderTx.GasTipCap)
		enc.Value = (*hexutil.Big)(itx.SenderTx.Value)
		enc.Input = (*hexutil.Bytes)(&itx.SenderTx.Data)
		enc.To = itx.SenderTx.to()
