...
var GovRewardeeImpMetaData = &bind.MetaData{
	ABI: "[{\"anonymous\":false,\"inputs\":[{\"indexed\":true,\"internalType\":\"address\",\"name\":\"recipient\",\"type\":\"address\"},{\"indexed\":false,\"internalType\":\"uint256\",\"name\":\"amount\",\"type\":\"uint256\"}],\"name\":\"RewardPaid\",\"type\":\"event\"},{\"inputs\":[],\"name\":\"GOV_STAKING\",\"outputs\":[{\"internalType\":\"address\",\"name\":\"\",\"type\":\"address\"}],\"stateMutability\":\"view\",\"type\":\"function\"},{\"inputs\":[{\"internalType\":\"addresspayable\",\"name\":\"recipient\",\"type\":\"address\"},{\"internalType\":\"uint256\",\"name\":\"amount\",\"type\":\"uint256\"},{\"internalType\":\"bool\",\"name\":\"ifSendingFee\",\"type\":\"bool\"}],\"name\":\"sendRewardTo\",\"outputs\":[],\"stateMutability\":\"nonpayable\",\"type\":\"function\"},{\"stateMutability\":\"payable\",\"type\":\"receive\"}]",
	Sigs: map[string]string{
		"e3966bc7": "GOV_STAKING()",
		"ff7fb167": "sendRewardTo(address,uint256,bool)",
	},
	Bin: "",
}
...
// SendRewardTo is a paid mutator transaction binding the contract method 0xff7fb167.
//
// Solidity: function sendRewardTo(address recipient, uint256 amount, bool ifSendingFee) returns()
func (_GovRewardeeImp *GovRewardeeImpTransactor) SendRewardTo(opts *bind.TransactOpts, recipient common.Address, amount *big.Int, ifSendingFee bool) (*types.Transaction, error) {
	return _GovRewardeeImp.contract.Transact(opts, "sendRewardTo", recipient, amount, ifSendingFee)
}

// SendRewardTo is a paid mutator transaction binding the contract method 0xff7fb167.
//
// Solidity: function sendRewardTo(address recipient, uint256 amount, bool ifSendingFee) returns()
func (_GovRewardeeImp *GovRewardeeImpSession) SendRewardTo(recipient common.Address, amount *big.Int, ifSendingFee bool) (*types.Transaction, error) {
	return _GovRewardeeImp.Contract.SendRewardTo(&_GovRewardeeImp.TransactOpts, recipient, amount, ifSendingFee)
}

// SendRewardTo is a paid mutator transaction binding the contract method 0xff7fb167.
//
// Solidity: function sendRewardTo(address recipient, uint256 amount, bool ifSendingFee) returns()
func (_GovRewardeeImp *GovRewardeeImpTransactorSession) SendRewardTo(recipient common.Address, amount *big.Int, ifSendingFee bool) (*types.Transaction, error) {
	return _GovRewardeeImp.Contract.SendRewardTo(&_GovRewardeeImp.TransactOpts, recipient, amount, ifSendingFee)
}
